...
class ECGRecorderGUI:
    ...
    def setup_ui(self):
        ...
        ttk.Label(left_frame, text="Hardware Configuration", font=("Helvetica", 12, "bold")).pack(anchor="w",
                                                                                                  pady=(0, 5))
        ...
        self.txt_output = tk.Text(left_frame, width=38, bg="#1e1e1e", fg="#00ff00", font=("Consolas", 9),
                                  relief=tk.FLAT)
    ...
    def load_default_demonstration(self):
        default_file = "livetest1/live_test.txt"
        ...
        try:
            ...
            if rate_hz > 860:
                messagebox.showwarning("Warning",
                                       "ADS1115 max capacity is 860 SPS. Values above 860 Hz may cause dropped data.")
                return
        except ValueError:
