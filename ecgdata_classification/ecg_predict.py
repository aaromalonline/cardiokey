...
class CardioKeyGUI:
    def __init__(self, root):
        ...
        # Prediction Section
        ttk.Label(left_frame, text="Live Subject Prediction", font=("Helvetica", 12, "bold")).pack(anchor="w", pady=(0, 2))
        ...
        self.txt_output = tk.Text(left_frame, width=35, bg="#1e1e1e", fg="#00ff00", font=("Consolas", 9), relief=tk.FLAT)
